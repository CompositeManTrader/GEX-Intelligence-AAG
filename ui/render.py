...
def show_dashboard() -> None:
    ...
    with tab_0dte:
        ...
        if zdte_c.empty and zdte_p.empty:
            ...
            if not zdte_df.empty and zdte_sum:
                ...
                with st.expander("SMILE 0DTE · IV(K) + selector de strikes IC (avanzado)"):
                    _doc(
                ...
                with st.expander("PERFIL ACUMULADO + GAMMA SCENARIO · flip dinámico (avanzado)"):
                ...
                with st.expander("TOP 0DTE STRIKES · tabla por |Net GEX|, OI y volumen"):
    ...
    with tab_erange:
        ...
        if not spot or spot <= 0:
            ...
            with st.expander("EM ACCURACY · ¿el modelo acierta? (calibración histórica)"):
